...
<? if (CMax::checkAjaxRequest2()): ?>
	...
	<div class="top-content-block">
		<? $APPLICATION->ShowViewContent('top_content'); ?><? $APPLICATION->ShowViewContent('top_content2'); ?></div>
	<? if (CMax::checkAjaxRequest2()): ?>
	</div>
<? endif; ?>
...
if ($section) {
	...
	if (
		!$typeTmpSKU || !$viewTmpFilter || !$arSection["DISPLAY"] || !$bSetElementsLineRow
...
<div class="main-catalog-wrapper clearfix">
	<div class="section-content-wrapper tbl <?= ($bShowLeftBlock ? 'with-leftblock' : ''); ?>">
		<?
		if ($section) {
			?>
			...
			<? if ($section[$arParams['SECTION_BG']]): ?>
				<div class="section-banner-top">
					<div class="section-banner-top__picture"
						style="background: url(<?= CFile::GetPath($section[$arParams['SECTION_BG']]) ?>) center/cover no-repeat;"></div>
				</div>
			<? endif; ?>
			<? $this->EndViewTarget(); ?>
